(function(exports, $, console, undefined) {
	...
	exports.SpyController.prototype.setupGame = function() {
		...
		// var inputs = $('.input_fields_wrap :input');
		// var newPlayers = [];
		// $.each(inputs, function(key, value) {
		// newPlayers.push($(value).val());
		// });

		game.initialize($("#playerCountOption").val());
		// var storageObj = newPlayers;
		// localStorage.setItem('spyfall.playerNames', JSON.stringify(storageObj));
